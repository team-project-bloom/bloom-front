          ...
          {isOpen && (
            <div className={classNames(styles.modal)}>
              {historyQuery.length !== 0 && (
                <div className={styles.modal__recent}>
              ...
              {popularQuery.length !== 0 && (
                <div className={styles.modal__popular}>
